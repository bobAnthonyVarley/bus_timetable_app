...
public class Bus {
	...
	String name; //the bus number, ie, 64d, 15A, 49
	...
	//stops at in Dublin
	ArrayList <ArrayList<Integer> > timetable;
	...
	public static ArrayList <ArrayList<Bus>> createBusObjects() {
		...
		Bus FortyNine_ToCityCentre_FromTerenureMM = new Bus("49", new ArrayList <ArrayList<Integer>>(), 
				"Terenure MM",  "busData\\Terenure_Mitsubishi_Motors\\49bus_data__TerenureMM.txt" );
		...
		Bus SixtyFiveB_ToCityCentre_FromTerenureALDI = new Bus("65B", new ArrayList <ArrayList<Integer>>(), 
				"Terenure ALDI", "busData\\Terenure_ALDI\\65Bbus_data_TerenureALDI.txt.txt");
		...
		Bus FortyNine_ToCityCentre_FromTerenureFD = new Bus("49", new ArrayList <ArrayList<Integer>>(), 
				"Terenure Funeral Directors", "busData\\Terenure_Funeral_Directors\\49bus_data_TerenureFuneralDirectors.txt");
	...
	public static ArrayList<Integer> findNextArrival(Bus bus, int hour, int min) {
		...
		for (; minutes_into_day>=minutes_into_day_of_selected_bus; j++ ) {
		...
		j--;
		int timeleft = minutes_into_day - ((bus.timetable.get(j).get(0)*60) + bus.timetable.get(j).get(1) );
